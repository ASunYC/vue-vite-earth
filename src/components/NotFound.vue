                    ...
                    <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                        <div class="max-w-3xl mx-auto text-center">
                            ...
                            <div class="relative inline-flex flex-col mb-6" data-aos="fade-up">
                                <!-- <img class="rounded-full" src="../images/404.jpg" width="196" height="196" alt="404" /> -->
                                <svg class="w-20 h-20 fill-current text-purple-600 absolute top-0 right-0 -mr-6"
                                    ...
                                    <path
                                        ...
                                        fill="#5D5DFF" fill-rule="evenodd" />
                                </svg>
                            </div>
                            <!-- 404 content -->
                            <h1 class="h1 mb-4" data-aos="fade-up" data-aos-delay="200">Uh oh. That page doesn’t exist.
                            </h1>
                            <p class="text-lg text-gray-400" data-aos="fade-up" data-aos-delay="400">Head to our
                                <router-link to="/"
                                    class="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">homepage</router-link>
